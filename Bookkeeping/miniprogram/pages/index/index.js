...
Page({
  ...
  data: {
    billTypes: [
      { billTypeInOut: '支出', billTypeName: '购物' },
      { billTypeInOut: '支出', billTypeName: '交通' },
      { billTypeInOut: '支出', billTypeName: '话费' },
      { billTypeInOut: '支出', billTypeName: '房租' },
      { billTypeInOut: '收入', billTypeName: '工资' },
      { billTypeInOut: '收入', billTypeName: '奖金' },
      { billTypeInOut: '收入', billTypeName: '退款' }
    ],
    accounts: [{
      accountName: '余额宝',
      accountMoney: '0.00'
